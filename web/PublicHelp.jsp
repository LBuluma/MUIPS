                            ...
                            <div class="accordion" id="accordionExample">
                                <div class="card">
                                    ...
                                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                        <div class="card-body">
                                            ...
                                            <p> 4. Fill the location information click "Next" </p>
                                            <p>(make sure to check the distinct feature or transportation option if the person has any unique feature, e.g spectacles, tattoo or transportation)</p>
                                            <p> 5. Optional if "Has distinct feature was selected" . Fill  the feature description and upload photo and click "Next</p>
                                            <p> 6. Optional if "Has transportation feature was selected" . Fill  the transportation form click "Finish"</p>
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapse2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <p>1. Click on the "Posts" option to view your posts</p>
